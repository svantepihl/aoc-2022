...
int PartOne(IEnumerable<string> input) => input.Select(line => line.Split(" ")).Select(game => game switch
{
...
int PartTwo(IEnumerable<string> input) => input.Select(line => line.Split(" ")).Select(game => game switch
    {
